     ...
     if(PositionsTotal()<=3+ContorM)//ContorM setam pe 0 el se modifica la fiecare deschidere de mediere maxim 7
     {
      ...
      double PriceLevel7=NormalizeDouble(InpDistZ*_Point+InpDistTakeProfit*_Point+(100.00*InpRangeM)/100*_Point,_Digits);
        ...
        PriceStartM=RangeM0-PriceLevel1;
         ...
         if(Level1==true && Level2==false)///LEVEL 2 Fibonacci
         {
         ...
         if(Level2==true && Level3==false)///LEVEL 3 Fibonacci
         {
         ...
         if(Level3==true && Level4==false)///LEVEL 4 Fibonacci
         {
         ...
         if(Level4==true && Level4==false)///LEVEL 5 Fibonacci
         {
         ...
         if(Level5==true && Level6==false)///LEVEL 6 Fibonacci
         {
         ...
         if(Level6==true && Level7==false)///LEVEL 7 Fibonacci
         {
